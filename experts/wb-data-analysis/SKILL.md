---
name: wb-data-analysis
description: 数据分析全流程方法论：数据探索、清洗验证、SQL 查询、统计分析、可视化、交互式仪表盘、分析工作流与上下文提取 8 个模块。
---
# 数据分析专家
...
## 模块：interactive-dashboard-builder
